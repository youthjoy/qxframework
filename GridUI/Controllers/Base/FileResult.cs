...
namespace QX.Controllers.Base
{
    public class FileResult : ActionResult
    {
        ...
        public FileResult(string fileName, string contentType, Encoding contentEncoding,
        ...
        public FileResult(string fileName, string contentType, Encoding contentEncoding,
                          IEnumerable<byte> data, IDictionary<string, string> headers)
