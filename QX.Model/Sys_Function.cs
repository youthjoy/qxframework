...
namespace QX.Model
{
   ...
   public partial class Sys_Function
   {
      ...
      private string fun_PName;
      private bool fun_PName_IsChanged=false;
      public string Fun_PName
      {
         get{ return fun_PName; }
         set{ fun_PName = value; fun_PName_IsChanged=true; }
      }
      public bool Fun_PName_IsChanged
      {
         get{ return fun_PName_IsChanged; }
         set{ fun_PName_IsChanged = value; }
      }
      /// <summary>
      /// 权限功能次序
      /// </summary>
